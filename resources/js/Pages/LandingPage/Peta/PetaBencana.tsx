...
export default function BencanaMap() {
    ...
    const [selectedFeature, setSelectedFeature] = useState<PopupMap | null>(
        null
    );

    const disasterData = [
        { key: "showBanjir", data: dataBanjir, type: "banjir" },
        {
            key: "showTanahLongsor",
            data: dataTanahLongsor,
            type: "tanahLongsor",
        },
        { key: "showGempa", data: dataGempa, type: "gempa" },
        { key: "showGelombang", data: dataGelombang, type: "gelombang" },
    ];
    ...
    const onEachFeature = useMemo(() => {
        return (type: "banjir" | "tanahLongsor" | "gempa" | "gelombang") =>
    ...
    return (
        <section
            id="map"
            className="w-full pt-32 bg-gray-500 max-h-full h-screen"
        >
            ...
            <div className="grid grid-cols-10 w-full gap-x-5 px-5">
